function reverseStr(str) {
  ...
  function clickHandler() {
    ...
    if(bdayStr !== "") {
      ...
      if(isPallindrome) {
        finalOutput.innerHTML = "Yay your birthday is a Pallindrome";
      } else {
        var [count, nextDate] = getNextPallindromeDate(date);
        finalOutput.innerHTML = `The next Pallindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed it by ${count} days!`; 
      }
    }
  }
